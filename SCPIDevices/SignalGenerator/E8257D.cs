...
using Shamrik.Dmitriy.SCPIDevices.SCPIDevices.SCPIData;
using Shamrik.Dmitriy.SCPIDevices.SCPIDevices.SignalGenerator.Enums;
using IExchangeService = Shamrik.Dmitriy.SCPIDevices.Exchanges.IExchangeService;

namespace Shamrik.Dmitriy.SCPIDevices.SCPIDevices.SignalGenerator
{
    /// <summary>
