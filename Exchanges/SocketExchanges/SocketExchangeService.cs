...
namespace Shamrik.Dmitriy.SCPIDevices.Exchanges.SocketExchanges
{
    /// <summary>
    ...
    /// </summary>
    public sealed class SocketExchangeService : IExchangeService, IDisposable
    {
        #region Constructor
        ...
        public SocketExchangeService(string ipAddress, int ipPort,
